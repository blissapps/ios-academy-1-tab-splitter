...
public let zeroDot5Decimal = Decimal(string: "0.5", locale: posixLocale)!
...
public let zeroDot01Eur = AmountValue(value: zeroDot01Decimal, currencyCode: "EUR")
public let zeroDot33Eur = AmountValue(value: zeroDot33Decimal, currencyCode: "EUR")
public let zeroDot5Eur = AmountValue(value: zeroDot5Decimal, currencyCode: "EUR")
public let oneEur = AmountValue(value: oneDecimal, currencyCode: "EUR")
public let twoEur = AmountValue(value: oneDecimal * 2, currencyCode: "EUR")
